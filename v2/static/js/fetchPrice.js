fetchData = function(){
    ...
    fetch('https://api.coingecko.com/api/v3/simple/price?ids=bitcoin%2Cethereum%2Cdogecoin%2Cbinancecoin%2Ctether%2Czelcash&vs_currencies=usd', {
      method: 'GET', // or 'PUT'
      headers: {
...
getResults = function(fetch_data){
	...
	rltPrice = fetch_data.tether.usd
