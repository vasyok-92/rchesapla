fetchData = function(){
    ...
    fetch('https://api.coingecko.com/api/v3/simple/price?ids=matic-network%2Cbitcoin%2Cethereum%2Cdogecoin%2Cbinancecoin%2Ctether%2Czelcash%2Csolana&vs_currencies=eur', {
      method: 'GET', // or 'PUT'
      headers: {
...
getResults = function(fetch_data){
    btcPrice = fetch_data.bitcoin.eur
    dogePrice = fetch_data.dogecoin.eur
    ethPrice = fetch_data.ethereum.eur
	bnbPrice = fetch_data.binancecoin.eur
	solPrice = fetch_data.solana.eur
	maticPrice = fetch_data.zelcash.eur
	rltPrice = fetch_data.tether.eur
